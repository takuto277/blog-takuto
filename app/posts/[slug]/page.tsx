          ...
          <div className="h-96 w-full overflow-hidden relative">
            ...
            <div className="absolute bottom-0 left-0 p-8 text-white">
              ...
              <div className="flex items-center">
                <span className="text-sm opacity-90">{formatDateFull(post.publishedAt)}</span>
              </div>
            </div>
          </div>
        )}
        ...
        {!post.coverImage && (
          <div className="px-6 py-8 md:px-10 md:py-12 border-b border-gray-100">
            ...
            <div className="flex items-center text-gray-500">
              <span className="text-sm">{formatDateFull(post.publishedAt)}</span>
            </div>
          </div>
        )}
        
        <div className="px-6 py-8 md:px-10 md:py-12 prose prose-indigo max-w-none">
          {post.content}
        </div>
